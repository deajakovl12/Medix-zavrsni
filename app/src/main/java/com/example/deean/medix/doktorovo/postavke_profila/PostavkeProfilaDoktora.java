...
public class PostavkeProfilaDoktora extends ToolbarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postaviDrawer(postaviToolbar("Postavke profila"),doktor.getIme().toUpperCase(),doktor.getPrezime().toUpperCase(),doktor.getEmail()).build();
    ...
    private void spremiPodatkeODoktoru(){
        AzurirajPodatkeDoktora.Factory.getIstance().response(doktor.getId_doktor(),etIme.getText().toString(),etPrezime.getText().toString(),etTitula.getText().toString(),etRadnoVrijeme.getText().toString(),etRadSavjetovalista.getText().toString(),etAdresa.getText().toString(),etTelefon.getText().toString(),etMobitel.getText().toString()).enqueue(new Callback<ArrayList<Integer>>() {
            @Override
            ...
            public void onFailure(Call<ArrayList<Integer>> call, Throwable t) {
                Log.e("NE", "NIJE USPIO");
                Doktor doktor1 = new Doktor(doktor.getId_doktor(),etIme.getText().toString(),etPrezime.getText().toString(),etAdresa.getText().toString(),doktor.getOib(),doktor.getLozinka(),etTelefon.getText().toString(),doktor.getEmail(),etRadnoVrijeme.getText().toString(),etRadSavjetovalista.getText().toString(),etMobitel.getText().toString(),etTitula.getText().toString());
